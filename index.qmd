...
- [__Economie__]{.orange} à l'ENS Lyon après B/L
    + [__Master APE (PSE)__]{.blue2} en 2015-2016

. . .

- Maths appliquées (Lyon 1, Jussieu) puis [__stats__]{.orange} (ENSAE) ;
...
- [__Découverte progressive de la _data science___]{.orange}:
...
![](https://utilitr.org/images/logo-utilitr.png){fig-align="center"}
...
- [__Participation à `RESIL`__]{.orange}: association de bases de données pour pallier l'absence de NIR ;

- [__Accompagnement BdF__]{.orange} pour codification automatique tickets de caisse dans COICOP ;

- Une [__IA assistante__]{.orange} pour s'y retrouver sur le site Insee
...
- [Moderniser une appli de _dataviz_ pour le suivi macroéconomique conjoncturel](https://radjerad.pages.lab.sspcloud.fr/inflation_internationale/)
...
Animation d'un réseau informel de _data scientists_ pour l'administration (+800 inscrits):
